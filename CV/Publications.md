...
* 11. **_Network States Classification based on Local Field Potential Recordings in the Awake Mouse Neocortex_**.   
...
* 9. **_Activity-dependent modulation of NMDA receptors by endogenous zinc shapes dendritic function in cortical neurons_**.    
...
* 8. **_A mean-field approach to the dynamics of networks of complex neurons, from nonlinear Integrate-and-Fire to Hodgkin–Huxley models_**.   
...
* 7. **_The Spectrum of Asynchronous Dynamics in Spiking Networks as a Model for the Diversity of Non-Rhythmic Waking States in Neocortex_**.    
...
* 6. **_Suppressive waves spread disambiguate the representation of long-range apparent motion in awake monkey_**.    
...
* 4. Enhanced Responsiveness and Low-Level Awareness in Stochastic Network States.  
...
* 2. Heterogeneous firing response of mice layer V pyramidal neurons in the fluctuation-driven regime
...
* 1. Gain Modulation of Synaptic Inputs by Network State in Auditory Cortex In Vivo.  
